...
#Region "Métodos"
    ...
    Private Sub IniciarServicio()
        ...
        Try
            ...
            elogLogEventos.WriteEntry("Inicio del servicio ""Procesamiento órdenes de laboratorio-ION"" V2.", EventLogEntryType.Information)
        ...
        Try
            ...
            If dtOrdenesNoProcesadas.Rows.Count > 0 Then
                ...
                For Each row In dtOrdenesNoProcesadas.Rows
                    ...
                    If Not strResultadoXmlClaves.Contains("ERROR") Then
