...
Namespace SP_BBDD
    ...
    Public Class TARL_ResultadoLaboratorioInterfaz_insert

        Public Sub New()
            MyBase.New()
        End Sub

        Public Overridable Function TARL_ResultadoLaboratorioInterfaz_insert(ByVal connection As System.Data.SqlClient.SqlConnection, ByVal transaccion As System.Data.SqlClient.SqlTransaction, ByVal table As System.Data.DataTable,
                                                        ByVal NoOrden As Long,
                                                        ByVal ResultadoXml As String)
            ...
            Else
                ...
                If (transaccion Is Nothing) Then
                    If (connection.State = System.Data.ConnectionState.Closed) Then
                        ...
                        'Abrir Conexion
                    End If
                    cmd = New System.Data.SqlClient.SqlCommand("TARL_ResultadoLaboratorioInterfaz_insert", connection)
                    cmd.CommandType = System.Data.CommandType.StoredProcedure
                Else
                    cmd = New System.Data.SqlClient.SqlCommand("TARL_ResultadoLaboratorioInterfaz_insert", connection, transaccion)
                    cmd.CommandType = System.Data.CommandType.StoredProcedure
                End If
                ...
                cmd.Parameters.Add("@ResultadoXml", System.Data.SqlDbType.VarChar)
                cmd.Parameters("@ResultadoXml").Direction = System.Data.ParameterDirection.Input
                cmd.Parameters("@ResultadoXml").Value = ResultadoXml
